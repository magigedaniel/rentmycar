    ...
    <body class="hold-transition skin-blue sidebar-mini fixed">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1 class="w3-center">
                    Voted vs Un-Voted Videos Chart<br/>
                    <small>voting bar graph</small>
                </h1>
                <ol class="breadcrumb">
                        <li><a href="/admin"><i class="fa fa-dashboard"></i> Admin</a></li>
                        <li><a href="/admin/video/voted/chart/data">Voting</a></li>
...
{{ $years[$year] }},
        ...
        label: 'Voted Cars',
                ...
                data: [
                        ...
                        echo $voted_videos_array[$years[$i]].',';
                        @endphp
                ]
        },
        {
        label: 'Un-Voted Videos',
                fillColor: 'green',
                ...
                data: [
                        @php
                        for($i = 0; $i < count($years); $i++)     
                        echo $un_voted_videos_array[$years[$i]].',';
                        @endphp
                ]
        }
        ]
