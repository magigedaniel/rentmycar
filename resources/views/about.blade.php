...
<html>
    <head>
        <title>RentMyCar.co.ke | About</title>
    ...
    <body class="sticky-header left-side-collapsed">
        <section>
            ...
            <div class="container" style="">
                <div class="modal fade" id="myModal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Terms and conditions to come here</p>
                            </div>
                ...
                <div class="modal fade" id="voting" role="dialog">
                    <div class="modal-dialog">
                        <!-- Modal content-->
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <div class="modal fade" id="selection" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Selection Criteria</h4>
                            </div>
                            <div class="modal-body">
                                <p>Content of selection criteria</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            </div>
