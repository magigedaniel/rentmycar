...
Route::get('/memberDashboard/{status}', 'DashboardController@getMemberDashboardOrderStatus');
...
Route::post('/memberDashboard/deposit/pay', 'DashboardController@postPaymentAmount');
